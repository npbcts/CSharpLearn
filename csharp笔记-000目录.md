...
### 前言部分
1. [csharp笔记-000前言](csharp笔记-000前言.md)  
2. [csharp笔记-000目录](csharp笔记-000目录.md)  


### 第一部分
3. [csharp笔记-100vscode_cs编程](csharp笔记-100vscode_cs编程.md)  
4. [csharp笔记-101第一个cs代码](csharp笔记-101第一个cs代码.md)  
5. [csharp笔记-102字符串入门](csharp笔记-102字符串入门.md)  
6. [csharp笔记-103字符串格式化](csharp笔记-103字符串格式化.md)  
...
### 第三部分
20. [csharp笔记-301正确选择数据类型](csharp笔记-301正确选择数据类型.md)  
21. [csharp笔记-302数值类型转换](csharp笔记-302数值类型转换.md)  
22. [csharp笔记-303字符串数字转换](csharp笔记-303字符串数字转换.md)  
23. [csharp笔记-304数组的常用方法](csharp笔记-304数组的常用方法.md)  
24. [csharp笔记-305字符串数组转换](csharp笔记-305字符串数组转换.md)  


### 第四部分
25. [csharp笔记-401数组](csharp笔记-401数组.md)  
26. [csharp笔记-405字典](csharp笔记-405字典.md)  
27. [csharp笔记-406字典的初始化](csharp笔记-406字典的初始化.md)  
28. [csharp笔记-407字典常用属性方法](csharp笔记-407字典常用属性方法.md)  
